    ...
    <div class="mx-lg-5 mt-lg-4 mb-lg-3">
        <div class="rounded bg-info pt-3 pb-3">
            <h2 class="text-center fw-bold mt-2">PRODUCTS</h2>
                <div>
                    <a  href="{{ route('product_table') }}"  class="btn btn-lg btn-primary mx-auto"> Ke Halaman Admin</a>
                    <a  href="{{ route('user_table2') }}"  class="btn btn-lg btn-success mx-auto"> Halaman Pengguna Mechant</a>
                </div>
