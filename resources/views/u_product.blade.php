    ...
    <div class="mrounded bg-info pt-3 pb-3" >
        <div class="d-flex  justify-content-around">
            ...
            <div>
                ...
                <a  href="{{route('get_form2')}}"  class="btn btn-lg btn-dark mx-auto"> Tambah Produk</a>
                ...
                <table class="table table-striped pt-3 pb-3"  style="margin: 20px;">
                    ...
                    <tbody>
                        ...
                        <td scope="col">
                            <a href="{{ route('posts.edit2', $item->id) }}" class="btn btn-warning">Edit</a>
                            <form action="{{ route('posts.destroy2', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
